...
public:
    ...
    void AddDocument(int document_id, const string& document, DocumentStatus status,
        ...
        if (document_id < 0 || documents_.count(document_id) == 1 || !IsSpecialSymbolsFree(document)) {
            throw invalid_argument("The document cannot be added, there is a problem with the id or the text"s);
        }
        ...
        id_sorted_by_add_sequence_.push_back(document_id);
    }
...
private:
    ...
    vector<int> id_sorted_by_add_sequence_;
    ...
    static bool IsSpecialSymbolsFree(const string& word) {
